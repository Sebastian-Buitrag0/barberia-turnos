...
public class TwilioWebhookController : ControllerBase
{
    ...
    private bool ValidateTwilioRequest()
    {
        ...
        if (string.IsNullOrEmpty(authToken))
        {
            ...
            {
                // If Twilio isn't configured, skip validation only in development
                return true;
            }

            _logger.LogError("Twilio AuthToken is missing in non-development environment. Denying request.");
            return false;
        }
